// 创建方块Z
class SquareZ extends TetrisElement {
    constructor(x, y, nowStatus,color) {
        super(x, y, nowStatus, SquareZ);
        this.status = [
            [{ offsetX: 0, offsetY: 0 }, { offsetX: 0, offsetY: -1 }, { offsetX: 1, offsetY: -1 }, { offsetX: 1, offsetY: -2 }],
            [{ offsetX: 1, offsetY: 0 }, { offsetX: 2, offsetY: 0 }, { offsetX: 1, offsetY: -1 }, { offsetX: 0, offsetY:-1 }],
            [{ offsetX: 0, offsetY: 0 }, { offsetX: 0, offsetY: -1 }, { offsetX: 1, offsetY: -1 }, { offsetX: 1, offsetY: -2 }],
            [{ offsetX: 1, offsetY: 0 }, { offsetX: 2, offsetY: 0 }, { offsetX: 1, offsetY: -1 }, { offsetX: 0, offsetY:-1 }],
        ];
        for (let i = 0; i < 4; i++) {
